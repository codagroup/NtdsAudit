...
public static class Program
{
    ...
    private static void PrintConsoleStatistics(NtdsAuditor ntds, DateTime baseDateTime)
    {
        Console.WriteLine();
    ...
    private static void WritePwDumpFile(string pwdumpPath, NtdsAuditor ntdsAudit, DateTime baseDateTime, bool includeHistoryHashes, bool wordlistInUse, string dumpReversiblePath, bool useRdn, bool anonymise)
    {
        ...
        {
            var usersWithHashes = ntdsAudit.Users.Where(x => x.LmHash != NtdsAuditor.EMPTY_LM_HASH || x.NtHash != NtdsAuditor.EMPTY_NT_HASH).ToList();
