namespace CODA.NtdsAudit
{
    public static class MockSecurity
    {
        ...
        public readonly static WKSID[] WellKnownSids = [
            ...
            new(['D', 'A'], MockSidType.DomainAdminsSid, new MAX_SID(SID_REVISION, 2, MockAuthority.NTAuthority, [(ulong)MockRid.BuiltinDomainRid, (ulong)MockRid.DomainGroupRidAdmins])), //Sub-Authorities will be defined by the domain.
