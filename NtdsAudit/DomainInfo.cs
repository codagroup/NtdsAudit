namespace CODA.NtdsAudit
{
    ...
    public class DomainInfo
    {
        ...
        /// </summary>
        public SecurityIdentifier AdministratorsSid { get; set; }
        ...
        /// </summary>
        public SecurityIdentifier DomainAdminsSid { get; set; }

        /// <summary>
        /// Gets or sets the SID of the Enterprise Admins group.
        /// </summary>
        public SecurityIdentifier EnterpriseAdminsSid { get; set; }
