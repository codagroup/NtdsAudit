...
{
    private readonly JetDBID _dbid;
    private readonly JetSesID _sesid;
    private readonly JetTableId _tableid;
    ...
    public JetDbTable(JetSesID sesid, JetDBID dbid, string tablename)
    {
        _sesid = sesid;
        _dbid = dbid;
    ...
    public IDictionary<string, JetColumnID> GetColumnDictionary()
    {
